...
export default function Home({ blogs, topics }) {
  return (
    <>
      <Head>
        <title>DevBlog </title>
        <meta name="title" content="DevBlog " />
        <meta
          name="description"
        ...
        <meta property="og:url" content="https://prakasravichandran.github.io/Blog/" />
        ...
        <meta property="twitter:url" content="https://prakasravichandran.github.io/Blog/" />
        <meta property="twitter:title" content="DevBlog" />
        <meta
